// Inventory Items Module - Complete JavaScript Implementation
console.log('Inventory Items JS loaded successfully');
    ...
    pageItems.forEach((item, index) => {
        ...
        row.innerHTML = `
            ...
            <td class="action-cell">
                ...
                <button class="action-btn update-btn" style="display:none;" onclick="updateItem(this)">
                    <i class="fas fa-save"></i>
                </button>
                <button class="action-btn cancel-btn" style="display:none;" onclick="cancelEdit(this)">
...
// Modal functions for Subcategory
...
// Modal functions for Inventory Item
